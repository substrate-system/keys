...
export const KeyDoesNotExist = new Error('Key does not exist. Make sure you ' +
    'properly instantiated the keystore.')
...
export const NotKey = new Error('Retrieved an asymmetric keypair when an ' +
    'symmetric key was expected. Please use a different key name.')
